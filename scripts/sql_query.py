...
## If there is an error (in Synapse table upload) it is usually silent,
...
class sql_query():
    ...
    def _convert_publication_date(self, df):
        '''
        ...
        for col in df.columns:
            if col == 'publicationDateUnix' or col == 'dateAdded' or col == 'dateModified':
...
if __name__ == '__main__':
    ...
    sql_query().run_sql_queries(args.save_local, args.save_to_synapse, args.config, args.path_to_column_types)
