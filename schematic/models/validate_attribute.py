...
class GenerateError:
    def generate_schema_error(
        row_num: str, attribute_name: str, error_msg: str
    ) -> List[str]:
        """
...
class ValidateAttribute(object):
    ...
    def cross_validation(
        ...
        (
            ...
            target_manifest_IDs,
            target_dataset_IDs,
        ) = ValidateAttribute.get_target_manifests(target_component, project_scope)
            ...
            if val_rule.__contains__("matchAtLeastOne") and not missing_values.empty:
                ...
                warnings.append(
                    GenerateError.generate_cross_warning(
                        ...
                        attribute_name=source_attribute,
                        invalid_entry=str(
                            pd.Series(invalid_values.squeeze()).values.tolist()
                        ),
                    )
                )
