...
from schematic.schemas.data_model_parser import parse_model
...
class DataModelGraph(metaclass=DataModelGraphMeta):
	'''
	...
	'''
	def __init__(
		path_to_data_model: str = None,
		):
		'''
		If no path_to_data_model, load default schema.
		'''
		self.data_model = parse_model(path_to_data_model)


	def generate_data_model_graph(self, data_model):
		'''
