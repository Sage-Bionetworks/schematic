...
class SynapseStorage(BaseStorage):
    ...
    def uploadDB(
        ...
        col_schema, table_manifest = self.formatDB(
            sg=sg, manifest=manifest, useSchemaLabel=useSchemaLabel
        )
    ...
    def _add_annotations(self, se, schemaGenerator, row, entityId, hideBlanks):
        ...
        annos = self.format_row_annotations(
            se, schemaGenerator, row, entityId, hideBlanks
        )
    ...
    def upload_manifest_as_csv(
        ...
        manifest = self.add_annotations_to_entities_files(
            se, schemaGenerator, manifest, manifest_record_type, datasetId, hideBlanks
        )
