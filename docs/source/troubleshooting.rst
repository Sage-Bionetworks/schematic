...
4. Does your data model has any "reserved word" as attribute names?
    1. The following are reserved words that should not be used as attribute names in your data model:
    ...
    2. The following also have special meaning to schematic. Please read carefully before using them in your data model:
