...
.. note::
   ...
   This concept is subject to feedback and `can` be changed.  Schematic currently has parameters in
   the API and CLI that refer to ``dataset``.  This is referring to the "top level folders".

Top level folders refers to Synapse folders that contains a group of files.
