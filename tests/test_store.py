...
class TestTableOperations:
    @pytest.mark.parametrize("table_column_names", ['display_name', 'display_label', 'class_label'], ids=['tcn_display_name', 'tcn_display_label', 'tcn_class_label'])
    @pytest.mark.parametrize("annotation_keys", ['display_label', 'class_label'], ids=['aks_display_label', 'aks_class_label'])
    def test_createTable(self, helpers, synapse_store, config: Configuration, projectId, datasetId, table_column_names,annotation_keys):
    ...
    @pytest.mark.parametrize("table_column_names", ['display_label', 'class_label'], ids=['tcn_display_label', 'tcn_class_label'])
    @pytest.mark.parametrize("annotation_keys", ['display_label', 'class_label'], ids=['aks_display_label', 'aks_class_label'])
    def test_replaceTable(self, helpers, synapse_store, config: Configuration, projectId, datasetId, table_column_names, annotation_keys):
    ...
    @pytest.mark.parametrize("annotation_keys", ['display_label', 'class_label'], ids=['aks_display_label', 'aks_class_label'])
    def test_upsertTable(self, helpers, synapse_store, config:Configuration, projectId, datasetId, annotation_keys):
