...
class TestManifestGenerator:
    ...
    def test_get_valid_values_from_jsonschema_property(self, ManifestGeneratorMock, req):
        '''
        ...
        mg=ManifestGeneratorMock
        loaded_json_schema = mg._get_json_schema(json_schema_filepath=None)
    ...
    def test_get_required_metadata_fields(self, ManifestGeneratorMock, fields):
        '''
