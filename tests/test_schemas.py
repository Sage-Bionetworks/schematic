...
class TestDfParser:
    ...
    def test_get_property_label_from_display_name(self, helpers):
        ...
        assert (
            se_obj.get_property_label_from_display_name("howToAcquire")
            == "howToAcquire"
        )
        assert (
            se_obj.get_property_label_from_display_name(
                "howToAcquire", strict_camel_case=True
            )
            == "howToAcquire"
        )
        assert (
            se_obj.get_property_label_from_display_name("how_to_acquire")
            == "howToAcquire"
        )
        assert (
            se_obj.get_property_label_from_display_name(
        ...
        assert (
            se_obj.get_property_label_from_display_name("How To Acquire")
            == "howToAcquire"
        )
        assert (
            se_obj.get_property_label_from_display_name(
        ...
        assert (
            se_obj.get_property_label_from_display_name("Model Of Manifestation")
        ...
        assert (
            se_obj.get_property_label_from_display_name("ModelOfManifestation")
            == "modelOfManifestation"
        )
        assert (
            se_obj.get_property_label_from_display_name(
    ...
    def test_get_class_label_from_display_name(self, helpers):
        ...
        # tests where strict_camel_case is the same
        assert (
            se_obj.get_class_label_from_display_name("howToAcquire") == "HowToAcquire"
        )
        assert (
            se_obj.get_class_label_from_display_name(
                "howToAcquire", strict_camel_case=True
            )
            == "HowToAcquire"
        )
        assert (
            se_obj.get_class_label_from_display_name("how_to_acquire") == "HowToAcquire"
        )
        assert (
            se_obj.get_class_label_from_display_name(
                "how_to_acquire", strict_camel_case=True
        ...
        assert (
            se_obj.get_class_label_from_display_name("How To Acquire") == "HowToAcquire"
        )
        assert (
            se_obj.get_class_label_from_display_name(
                "How To Acquire", strict_camel_case=True
        ...
        assert (
            se_obj.get_class_label_from_display_name("Model Of Manifestation")
            == "ModelOfManifestation"
        )
        assert (
            se_obj.get_class_label_from_display_name(
        ...
        assert (
            se_obj.get_class_label_from_display_name("ModelOfManifestation")
            == "ModelOfManifestation"
        )
        assert (
            se_obj.get_class_label_from_display_name(
